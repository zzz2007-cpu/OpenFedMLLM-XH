...
setup(
    ...
    packages=[
        ...
        *find_packages(include=('fling_mllm', 'fling_mllm.*')),
        *find_packages(include=('mllmzoo', 'mllmzoo.*')),
        *find_packages(include=('mllm', 'mllm.*')),
    ...
    entry_points={
        'console_scripts': [
            ...
            'mllmzoo-list=mllmzoo.cli:list_models_cli',
            'mllmzoo-train=mllmzoo.cli:train_model_cli'
        ]
    },
    extras_require={
        'test': [
