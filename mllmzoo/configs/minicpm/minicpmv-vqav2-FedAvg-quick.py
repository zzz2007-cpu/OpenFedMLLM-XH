...
exp_args = dict(
    ...
    data_args=dict(
        data_path="./partition_vqav2_supercat_dirichlet_clients10/alpha_0.5",
    ...
    training_args=dict(
        output_dir="./mllmzoo/output/minicpmv_vqav2_fedavg_quick",
        ...
        use_lora=True,
        enable_audio=False,
        max_steps=int(os.environ.get("OPENFED_MAX_STEPS", "20")),
    ),
    lora_args=dict(
        lora_r=8,
        lora_alpha=16,
...
if __name__ == "__main__":
    ...
    run_federated_with_task_metrics_hook(exp_args, run_name="minicpmv_vqav2_fedavg_quick")
