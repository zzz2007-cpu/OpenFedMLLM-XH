...
_runtime = resolve_runtime_overrides(
    ...
    default_output_dir="./mllmzoo/output/minicpmv_crisismmid_fedprox",
...
if __name__ == "__main__":
    ...
    def _maybe_redirect_rank_logs(output_dir):
        ...
        if tee:
            ...
            sys.stderr = log_fp
        print(
            f"[minicpmv_crisismmid_fedprox] rank log redirected: rank={rank}, local_rank={local_rank}, "
    ...
    if exp_args.eval_args.eval_data_path and not os.path.exists(exp_args.eval_args.eval_data_path):
        print(
            "[minicpmv_crisismmid_fedprox] WARNING: eval_data_path not found: "
            f"{exp_args.eval_args.eval_data_path}. Per-round eval will be skipped."
        )

    print(
        "[minicpmv_crisismmid_fedprox] data_path="
