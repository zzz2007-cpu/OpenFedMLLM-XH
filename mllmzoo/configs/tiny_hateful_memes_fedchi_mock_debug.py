...
root = Path(os.environ.get("OPENFED_HATEFUL_MEMES_ROOT", "./tmp/mock_hateful_memes"))
stat_setting = os.environ.get("OPENFED_HATEFUL_MEMES_STAT", "dir_0.5")
modal_setting = os.environ.get("OPENFED_HATEFUL_MEMES_MODAL", "cross_1_1")
...
output_dir = os.environ.get(
    ...
    "./outputs/checkpoints/hm_tiny_cpu_fedchi_mock_debug",
)
