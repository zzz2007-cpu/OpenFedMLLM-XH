...
def build_scienceqa_chi_exp(
    ...
    return EasyDict(
        ...
        fed_args=dict(
            ...
            save_global_model_freq=_env_int("SAVE_GLOBAL_MODEL_FREQ", 1),
            resume_from_round=_env_int("RESUME_FROM_ROUND", 0),
            resume_global_checkpoint=os.environ.get("RESUME_GLOBAL_CHECKPOINT") or None,
            fedopt_tau=1e-3,
            fedopt_eta=1e-3,
            fedopt_beta1=0.9,
            fedopt_beta2=0.99,
        ...
        eval_args=dict(
            ...
            max_samples=_env_int("EVAL_MAX_SAMPLES", 100),
            eval_sample_seed=_env_int("EVAL_SAMPLE_SEED", 42),
            startup_eval_full=False,
            final_eval_full=os.environ.get("FINAL_EVAL_FULL", "1") == "1",
